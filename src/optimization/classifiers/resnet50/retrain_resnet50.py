...
checkpoint = ModelCheckpoint("retrained_resnet50.h5", monitor='val_accuracy', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
...
model.save('retrained_resnet50.h5')
